...
namespace Mpn.Data
{
    public class MpnDbMigrationService : ITransientDependency
    {
        public ILogger<MpnDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IMpnDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public MpnDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IMpnDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<MpnDbMigrationService>.Instance;
        }
