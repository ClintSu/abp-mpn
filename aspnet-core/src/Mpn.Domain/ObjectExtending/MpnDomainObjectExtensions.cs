...
namespace Mpn.ObjectExtending
{
    public static class MpnDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the MpnEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
